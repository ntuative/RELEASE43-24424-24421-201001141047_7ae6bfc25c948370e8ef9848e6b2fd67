package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1013:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_1013.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1014)
         {
            ...
            var_686["null"] = new FigureData(this);
            var_686["null"] = new FigureData(this);
            _loc1_ = var_686["null"];
            _loc2_ = var_686["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_82);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_85);
            var_338 = new Map();
            var_338.add(AvatarEditorCategory.const_974,new GenericModel(this));
            var_338.add(AvatarEditorCategory.const_47,new HeadModel(this));
            var_338.add(AvatarEditorCategory.const_289,new TorsoModel(this));
            var_338.add(AvatarEditorCategory.const_1186,new LegsModel(this));
            var_338.add(AvatarEditorCategory.const_521,new WardrobeModel(this));
            var_1014 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_338.getValue(AvatarEditorCategory.const_521);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_338.getValue(AvatarEditorCategory.const_521);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_1013.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1529.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1360)
               {
                  _loc19_ = true;
               }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_338.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_414 == null)
            {
               var_414 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_414.addChild(_view.window);
               var_414.center();
               var_414.visible = false;
            }
            var_414.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_974);
         if(var_177 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1162 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_641,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_1013 = var_1162.getFigureData(AvatarType.const_86);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_1012 = param3;
         var _loc4_:FigureData = var_686[param2];
         if(_loc4_ == null)
         {
            return;
         }
