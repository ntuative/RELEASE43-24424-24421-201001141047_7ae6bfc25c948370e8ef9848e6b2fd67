package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1090:String = "Default";
      ...
      private var var_559:AvatarFigureContainer;
      ...
      private var var_467:IAvatarDataContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         var_559 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_559.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_985;
         }
         var_147 = new AvatarImageCache(var_78,this,_assets,var_197);
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            param2 = AvatarDirectionAngle.const_693 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_693)
         {
            param2 -= NaN;
         }
         if(var_701 == AvatarType.PET && param1 == AvatarSetType.const_47)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_78.sortActions(var_196);
         if(_loc1_ == null)
         {
         ...
         {
            var_558 = var_78.getCanvasOffsets(_loc1_,var_197,var_98);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_467 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_663)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_396)
            {
               _isAnimating = true;
            }
      ...
      {
         return var_78.getPartColor(var_559,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_78.getCanvas(var_197,var_178.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_78.getBodyParts(param1,var_178.definition,var_98);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_466);
            if(_loc10_ != null)
            {
               ...
               if(var_701 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_78.getParts(_loc9_,var_559,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_197 == AvatarScaleType.const_97)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_466);
                     _loc21_ = var_98;
                     _loc22_ = 1;
                     switch(var_98)
                     {
                     ...
                     _loc23_ = var_78.getPartActionOffset(getSubType(),var_197,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_78.getCanvas(var_197,var_178.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_78.getBodyParts(param1,var_178.definition,var_98);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_466);
            if(_loc8_ != null)
            {
               ...
               if(var_701 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_78.getParts(_loc7_,var_559,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_466);
                     _loc19_ = var_98;
                     _loc20_ = 1;
                     switch(var_98)
                     {
                     ...
                     _loc21_ = var_78.getPartActionOffset(getSubType(),var_197,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
         ...
         if(var_467 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_467.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_178 = new ActiveActionData(AvatarAction.const_1005);
         var_178.definition = var_78.getActionDefinition(const_1090);
      ...
      {
         return var_78.getBodyPartData(param1.animation.id,var_466,param1.id);
      }
