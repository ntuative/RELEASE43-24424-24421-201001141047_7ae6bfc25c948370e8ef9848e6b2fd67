package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_419:PartSetsData;
      
      private var var_2157:PartOffsetData;
      
      private var var_864:AvatarActionManager;
      
      private var var_163:IAssetLibrary;
      
      private var var_2237:IAssetLibrary;
      
      private var var_1311:Boolean = false;
      
      private var var_2158:AvatarRenderManager;
      ...
      private var var_1521:AvatarStructureDownloadSet;
      
      private var var_702:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_419 = new PartSetsData();
         _animationData = new AnimationData();
         var_1521 = new AvatarStructureDownloadSet();
         var_702 = new AnimationManager();
         var_701 = param4;
         var_2157 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_864.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_701)
         {
            case AvatarType.const_86:
               _loc1_ = var_163.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_419.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_163.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_163.getAssetByName("HabboAvatarFigure").content as XML;
               ...
               break;
            case AvatarType.PET:
               _loc1_ = var_163.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_419.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_163.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_163.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_497.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_864.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_864.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_702.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_419.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_419.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1140[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_864.getDefaultActionType();
         var _loc7_:Array = var_419.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_702.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            if(_loc23_ != null)
            {
               _loc24_ = var_497.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_419.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_419.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_86:
               if(var_163.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_163.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_163.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_163.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_701 + " ready to go!");
         if(var_701 == AvatarType.const_86)
         {
            var_419.getPartDefinition("ri").appendToFigure = true;
            var_419.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_86:
               var_1521.add(new AvatarStructureDownload(var_163,_loc5_,var_497));
               break;
            case AvatarType.PET:
         }
         var_1521.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_702.getAnimation(param1);
      }
      ...
      {
         var_864 = new AvatarActionManager(var_163,var_701);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_163.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_163.getAssetByName("dance" + _loc1_).content as XML;
            var_702.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_163.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_163.getAssetByName("fx" + _loc1_).content as XML;
            var_702.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_497.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_497.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_864.sortActions(param1);
      }
   }
}
