package com.sulake.habbo.avatar.structure
{
   ...
   public class FigureData implements IStructureData, IFigureData
   {
      ...
      {
         super();
         var_1004 = new Dictionary();
         var_1005 = new Dictionary();
      }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_1004[String(_loc2_.@id)] = new Palette(_loc2_);
         }
         for each(_loc3_ in param1.sets[0].settype)
         {
            var_1005[String(_loc3_.@type)] = new SetType(_loc3_);
         }
         return true;
      }
      ...
      {
         return var_1004[String(param1)];
      }
      
      public function getSetType(param1:String) : ISetType
      {
         return var_1005[param1];
      }
      ...
      public function append(param1:XML) : Boolean
      {
         ...
         for each(_loc2_ in param1.colors[0].palette)
         {
            _loc4_ = var_1004[String(_loc2_.@id)];
            if(_loc4_ == null)
            {
               var_1004[String(_loc2_.@id)] = new Palette(_loc2_);
            }
         ...
         for each(_loc3_ in param1.sets[0].settype)
         {
            _loc5_ = var_1005[String(_loc3_.@type)];
            if(_loc5_ == null)
            {
               var_1005[String(_loc3_.@type)] = new SetType(_loc3_);
            }
