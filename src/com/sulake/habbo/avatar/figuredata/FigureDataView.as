package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_485:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1085 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_485 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_485.bitmap = new BitmapData(var_485.width,var_485.height,true,16777215);
         var_485.bitmap.copyPixels(var_1085,var_1085.rect,new Point(0,0 - 0 - 8));
         var_485.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
