package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_883:CoreComponent;
      
      private var var_33:AssetAliasCollection;
      
      private var var_1025:PaletteManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_687 = RenderMode.const_1309;
         if(param1 is CoreComponent)
         {
            var_883 = CoreComponent(param1);
            var_883.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,onComponentsRunning);
         }
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_307.getValue(AvatarType.const_86) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc1_:AssetLibraryCollection = var_883.assets as AssetLibraryCollection;
         var _loc2_:int = 0;
         ...
         var_1025 = new PaletteManager(_loc1_,_loc3_);
         ...
         var_307.add(AvatarType.const_86,_loc5_);
      ...
      {
         var_687 = param1;
         if(var_687 == RenderMode.const_1343)
         {
            init();
         }
      }
      ...
      {
         var _loc5_:String = var_693.createAvatarFigureStringNew(param1,param2,param3);
      ...
      {
         var _loc3_:AvatarStructure = var_307.getValue(AvatarType.const_86) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_33,param1,param2,AvatarType.const_86);
      }
