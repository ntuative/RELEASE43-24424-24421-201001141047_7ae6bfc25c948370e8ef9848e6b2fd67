package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1522 = new Dictionary();
         super();
         _id = String(param1.@id);
         _state = String(param1.@state);
         var_2166 = parseInt(param1.@precedence);
         var_2165 = String(param1.@activepartset);
         var_2163 = String(param1.@assetpartdefinition);
         var_2164 = String(param1.@lay);
         var_1297 = String(param1.@geometrytype);
         var_2168 = Boolean(parseInt(param1.@main));
         var_2162 = Boolean(parseInt(param1.@WindowMouseOperator));
         var_2161 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1190 = _loc2_.split(",");
         }
         for each(_loc3_ in param1.param)
         {
            _loc5_ = String(_loc3_.@id);
            _loc6_ = String(_loc3_.@value);
            if(_loc5_ == "WindowMouseOperator")
            {
               var_2167 = _loc6_;
            }
            else
            {
               var_1522[_loc5_] = _loc6_;
            }
         }
      ...
      {
         return var_1190.concat(getTypePrevents(param1));
      }
