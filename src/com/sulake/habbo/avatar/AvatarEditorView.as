package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1529:IWindowContainer;
      
      public static var var_1299:IWindowContainer;
      
      public static var var_1044:int = 6710886;
      ...
      private var var_1493:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1299 == null)
         {
            ...
            var_1299 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1529 == null)
         {
            _loc4_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1529 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_616 != null)
         {
            toggleCategoryView(var_616,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1493 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_616 = param1;
         var_1493.setSelected(var_1493.getSelectableByName(param1));
         _window.invalidate();
      }
