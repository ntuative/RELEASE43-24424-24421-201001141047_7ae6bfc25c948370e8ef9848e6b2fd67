package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_615 > -1)
         {
            return var_330[var_615] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_615 >= 0)
         {
            _loc3_ = var_330[var_615];
            _loc3_.isSelected = false;
         }
         if(var_330.length > param1)
         {
            _loc2_ = var_330[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_615 = param1;
