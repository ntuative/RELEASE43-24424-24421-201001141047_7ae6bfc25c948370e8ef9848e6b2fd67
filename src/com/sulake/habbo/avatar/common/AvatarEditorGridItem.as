package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_360 = new BitmapData(1,1,true,16777215);
         }
         else
         {
            var_1008 = param3.isColorable;
         }
         var_1008 = param5;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            if(var_360 != null)
            {
               _loc2_ = var_360.clone();
               if(_color != null && var_1008)
               {
         ...
         if(var_577 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1414,var_1414.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_849.width,var_849.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_925 + "_" + FigureData.const_237;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_1008 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_925 + "_" + FigureData.const_237;
