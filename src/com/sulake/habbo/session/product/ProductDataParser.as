package com.sulake.habbo.session.product
{
   ...
   public class ProductDataParser extends EventDispatcher
   {
      ...
      public static const const_148:String = "ready";
      ...
      private function parseProductsData(param1:Event) : void
      {
         ...
         for each(_loc10_ in _loc8_)
         {
            ...
            for each(_loc12_ in _loc11_)
            {
               ...
               var_812[_loc14_] = _loc18_;
            }
            _loc9_++;
         }
         dispatchEvent(new Event(const_148));
      }
      ...
      {
         Core.crash("Failed to load product data due to IOError: " + param1.text + " " + param1.type,CoreComponent.const_1195);
      }
