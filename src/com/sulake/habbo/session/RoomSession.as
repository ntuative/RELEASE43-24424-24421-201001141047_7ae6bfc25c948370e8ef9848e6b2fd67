package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_975:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_312 && _connection != null)
         {
      ...
      {
         return var_975 as IUserDataManager;
      }
