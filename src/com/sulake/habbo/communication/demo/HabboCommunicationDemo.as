package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1781:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1398:ILogger;
      ...
      private var var_451:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1780)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_632 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_632);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1149,var_1782));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_451.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_451.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1781);
      ...
      {
         var_632 = _habboConfiguration.getKey("sso.ticket",null);
         var_1149 = _habboConfiguration.getKey("flash.client.url","");
         var_1782 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_172 == null)
         {
         ...
         if(var_632 != null)
         {
            var_76.mode = HabboConnectionType.const_403;
            var_76.initConnection(HabboConnectionType.const_266);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1398 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1781 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_76.mode)
         {
            case HabboConnectionType.const_403:
               ...
               var_942 = _loc4_;
               var_172.loadBannerImage(_loc7_ + "?token=" + var_942,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1253:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1194:
               var_943 = generateRandomHexString(30);
               var_451 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_451.init(var_943);
               _loc8_ = var_451.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_942);
         ...
         var_451 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_943 = generateRandomHexString(30);
            var_451.init(var_943);
            _loc12_ = var_451.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_35.events.addEventListener(RoomSessionEvent.const_95,onRoomSessionEnded);
      }
