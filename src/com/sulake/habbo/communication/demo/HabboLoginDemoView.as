package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_661:String = "InitConnection";
      ...
      private var var_344:HabboCommunicationDemo;
      ...
      {
         var_344.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_344.shockwaveClientUrl = var_122.shockwaveClientUrl;
         var_344.ssoTicket = var_122.ticket;
         var_122.removeEventListener(SSOTicket.const_277,onParsedTicketSuccess);
         var_122.removeEventListener(SSOTicket.const_240,onParsedTicketFailure);
         var_122 = null;
         dispatchEvent(new Event(const_661));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1403,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_344 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_344.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_405,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_344.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1403,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_344.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_344.habboCommunication.habboWebLogin(name,password);
         var_122 = new SSOTicket(var_344.assets,_loc2_,_loc1_);
         var_122.addEventListener(SSOTicket.const_277,onParsedTicketSuccess);
         var_122.addEventListener(SSOTicket.const_240,onParsedTicketFailure);
      }
