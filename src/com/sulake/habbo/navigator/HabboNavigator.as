package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_339:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_2079:ISessionDataManager;
      
      private var var_2078:RoomCreateViewCtrl;
      
      private var var_1930:RoomThumbnailRenderer;
      
      private var var_187:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1268:RoomInfoViewCtrl;
      
      private var var_88:IHabboCatalog;
      
      private var var_393:Tabs;
      
      private var var_483:MainViewCtrl;
      
      private var var_2080:Array;
      
      private var var_936:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_483 = new MainViewCtrl(this);
         var_1268 = new RoomInfoViewCtrl(this);
         var_2078 = new RoomCreateViewCtrl(this);
         var_1930 = new RoomThumbnailRenderer(this);
         var_936 = new GuestRoomPasswordInput(this);
         var_339 = new GuestRoomDoorbell(this);
         var_393 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_483.startSearch(Tabs.const_216,Tabs.const_298,param1);
         var_483.mainWindow.activate();
      }
      ...
      public function goToRoom(param1:int, param2:Boolean, param3:String = "") : void
      {
         ...
         if(var_35)
         {
            ...
            var_1268.close();
            var_35.gotoRoom(false,param1,param3);
         }
      }
      ...
      public function goToPublicSpace(param1:int, param2:String) : void
      {
         ...
         {
            var_1268.close();
            var_35.gotoRoom(true,param1,"",param2);
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2079 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_483.startSearch(Tabs.const_262,Tabs.const_212);
         var_393.getTab(Tabs.const_262).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_483.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
