package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_382:IRoomSettingsCtrlOwner;
      ...
      private var var_1141:ICheckBoxWindow;
      
      private var _navigator:HabboNavigator;
      
      private var var_1142:ICheckBoxWindow;
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in var_75.controllers)
         {
      ...
      private function onRemoveFlatCtrlClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in var_75.controllers)
         {
            if(_loc4_.selected)
            {
      ...
      {
         close();
         this.var_382.roomSettingsRefreshNeeded();
      }
      ...
      private function controllerExists(param1:int) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_75.controllers.length)
         {
            _loc3_ = var_75.controllers[_loc2_];
      ...
      public function onFlatControllerRemoved(param1:int, param2:int) : void
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < var_75.controllers.length)
         {
            _loc4_ = var_75.controllers[_loc3_];
            if(_loc4_.userId == param2)
            {
               var_75.controllers.splice(_loc3_,1);
            }
            else
            {
               _loc3_++;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in var_75.controllers)
         {
            if(_loc1_.selected)
            {
               return true;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_382.roomSettingsRefreshNeeded();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_383);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_75.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_383]);
         _loc2_.show();
      }
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < var_75.controllers.length)
         {
            _loc10_ = var_75.controllers[_loc9_];
         ...
         if(var_75.controllers.length > 0)
         {
            _loc1_.visible = true;
            _loc7_.visible = true;
            _loc5_.visible = true;
            if(var_75.controllerCount > var_75.controllers.length)
            {
               _navigator.registerParameter("navigator.roomsettings.flatctrls.limitinfo","cnt","" + var_75.controllers.length);
               _loc6_.visible = true;
            }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1387.visible = _inRoom;
         var_1386.visible = _inRoom;
         var_1763.visible = var_450;
         var_1762.visible = !var_450;
         if(var_450)
         {
            var_935.visible = true;
            var_1138.visible = false;
            refreshFlatControllers();
            var_935.height = Util.getLowestPoint(this.var_935) + 4;
         }
         else
         {
            populateForm();
            ...
            var_1140.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1140.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_938.height = Util.getLowestPoint(this.var_938) + 4;
         }
         var_1385.text = !!var_450 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1387.name,var_1140.name,var_938.name,var_935.name,var_1138.name,var_1386.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         var_1388 = false;
         var _loc1_:RoomSettingsData = var_75;
         var_773.setText(_loc1_.name);
         var_1137.setText(_loc1_.description);
         var_936.setText("");
         var_1139.setText("");
         ...
         setTag(var_722,_loc1_.tags[0]);
         setTag(var_721,_loc1_.tags[1]);
         if(var_1142)
         {
            if(_loc1_.allowPets)
            {
               this.var_1142.select();
            }
            else
            {
               this.var_1142.unselect();
            }
         }
         if(var_1141)
         {
      ...
      {
         this.var_383 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_383));
         if(var_937 != null)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.roomId = var_75.roomId;
         _loc2_.name = var_773.getText();
         _loc2_.description = var_1137.getText();
         ...
         {
            _loc8_ = var_936.getText();
            _loc9_ = var_1139.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_936.clearErrors();
         ...
         _loc2_.allowPets = var_1142.isSelected;
         _loc2_.allowFoodConsume = var_1141.isSelected;
         _loc2_.allowFurniMoving = var_75.allowFurniMoving;
         _loc2_.allowTrading = var_75.allowTrading;
         _loc2_.showOwnerName = var_75.showOwnerName;
         _loc2_.tags = new Array();
         addTag(var_722,_loc2_.tags);
         addTag(var_721,_loc2_.tags);
         this.clearErrors();
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_383));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_383 || var_934 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_934 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1220)
         {
         ...
         {
            this.var_1137.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1341)
         {
            setTagError(this.var_722,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_721,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1318)
         {
            setTagError(this.var_722,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_721,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1207)
         {
            this.var_936.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_624,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_920,onDoorModePasswordUnselect);
         ...
         refreshCategories();
         this.var_773 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1137 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_722 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_721 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_936 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1139 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1142 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1141 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         var_1387 = IWindowContainer(_window.findChildByName("header_container"));
         var_1140 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_938 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_935 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1386 = IWindowContainer(_window.findChildByName("switch_view_container"));
         ...
         var_937 = IWindowContainer(_window.findChildByName("password_container"));
         var_1762 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1763 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1385 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1385.procedure = onSwitchView;
         var_937.visible = false;
         if(!_inRoom)
         {
