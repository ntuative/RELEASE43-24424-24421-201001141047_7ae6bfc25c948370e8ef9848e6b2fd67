package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1293 = new Timer(100);
         var_1293.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_69 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1035 = new TextFieldManager(_navigator,ITextFieldWindow(var_34.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1951 = _navigator.data.hcMember;
      }
      ...
      private function refresh() : void
      {
         ...
         var_866 = var_69[0];
         if(var_1951 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_39,HabboWindowParam.const_66,new Rectangle(0,0,100,300)));
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1294 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1294 = true;
            _loc3_.y = 1;
