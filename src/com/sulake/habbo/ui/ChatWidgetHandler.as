package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_794:Number = 0;
      
      private var var_460:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_135];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_458 != null)
         {
            ...
            {
               _loc2_ = var_458.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_135:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_458.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_646.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_275:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_458.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_646.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_551,RoomWidgetChatSelectAvatarMessage.const_690];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_551:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_135,_container.roomSession,0,"Version 24424-24421-201001141019");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_284);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_373);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_794 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_794);
            }
            if(var_460 == null)
            {
               var_459.x = 0;
               var_459.y = 0;
               var_459.z = 0;
               var_460 = _loc4_.getScreenPoint(var_459);
               var_794 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_459.x = 0;
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_460.x || _loc8_.y != var_460.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_460,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_310;
      }
