package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               ...
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_131,onPetInfo);
         ...
         if(false)
         {
            ...
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_131,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_675);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_326);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_993);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_928);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_275)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_442)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_865)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_201)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_196)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_712);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1203;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1002;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_783;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1303);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_561.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_51);
            var_561.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_712);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_601);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_668);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_565);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1247);
         _loc1_.push(RoomWidgetPetCommandMessage.const_636);
      ...
      public function dispose() : void
      {
         ...
         if(var_561 != null)
         {
            _loc1_ = var_561.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_561.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_440)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetFurniActionMessage.const_254:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_601:
            ...
            case RoomWidgetUserActionMessage.const_374:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_668:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_565:
            ...
            case RoomWidgetPetCommandMessage.const_662:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_636:
