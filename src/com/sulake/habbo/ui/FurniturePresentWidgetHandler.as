package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1054:String = "poster";
      ...
      {
         return [RoomSessionPresentEvent.const_222];
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_703,RoomWidgetPresentOpenMessage.const_694,RoomWidgetPresentOpenedMessage.const_1239];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(_container != null && false && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_222:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_74:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_419,0,_container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           ...
                           else if(_loc3_ != null && _loc3_.name == const_175)
                           {
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1054)
                              {
                                 break;
                              }
