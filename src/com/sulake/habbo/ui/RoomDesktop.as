package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1802:IHabboHelp = null;
      ...
      private var var_781:IRoomWidgetFactory = null;
      
      private var var_35:IRoomSessionManager = null;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var _windowManager:IHabboWindowManager = null;
      
      private var var_1162:IAvatarRenderManager = null;
      ...
      private var var_1810:uint = 16777215;
      
      private var var_88:IHabboCatalog = null;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_454,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_355,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_504,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_638 = _roomEngine.loadRoomResources(var_48.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         {
            var_1161 = !var_454.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_48.roomId,var_48.roomCategory,var_260[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_220 != null)
         {
            ...
            {
               _loc5_ = var_220.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_454,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_355,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_504,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_35 = null;
         var_781 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1810);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_220.length)
         {
            _loc2_ = var_220.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_187 != null)
         {
            var_221.toolbarSize = var_187.size;
            var_221.toolbarOrientation = var_187.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_781.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_589:
               ...
               if(var_1401 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
                  _loc7_ = var_48.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_442)
                  {
                     var_1401.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_431:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_193,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_109:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_633,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_220.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_48.roomId,var_48.roomCategory,RoomVariableEnum.const_666);
            _loc13_ = _roomEngine.getRoomNumberValue(var_48.roomId,var_48.roomCategory,RoomVariableEnum.const_512);
            _loc14_ = _roomEngine.getRoomNumberValue(var_48.roomId,var_48.roomCategory,RoomVariableEnum.const_717);
            _loc15_ = _roomEngine.getRoomNumberValue(var_48.roomId,var_48.roomCategory,RoomVariableEnum.const_545);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_436:
               ...
               var_173 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_250,WindowParam.const_84) as IToolTipWindow;
               var_173.setParamFlag(WindowParam.const_48,false);
      ...
      {
         if(var_35 != null && var_48 != null && var_1161 && var_9)
         {
            var_35.startSession(var_48);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_225));
         }
      }
