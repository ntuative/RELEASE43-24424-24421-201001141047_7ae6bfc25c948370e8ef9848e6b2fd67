package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1027:Number = 90;
      
      private static const const_770:int = 50;
      
      private static const const_1026:Number = 25;
      
      private static const const_1102:int = 50;
      
      private static const const_178:Boolean = true;
       
      
      private var var_567:Timer;
      
      private var var_1006:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1006 = param2;
         var_567 = new Timer(const_1026);
         var_567.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            var_478.splice(_loc3_,1);
         }
         var_478.push(param1.name);
         var_479.push(param2);
         param1.addEventListener(WindowEvent.const_411,windowEventListener);
         param1.addEventListener(WindowEvent.const_208,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_479[var_478.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1006.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_304.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_304.splice(var_304.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1006.getIconLoc(param1.iconId);
      ...
      {
         return var_478[var_479.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_304[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_566[_loc3_] = new Array();
            }
            if(var_566[_loc3_].indexOf(param1) < 0)
            {
               var_566[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_770 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_770 || param1.desktop.height - param1.y < const_1102;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_478.length)
         {
            if(var_478[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_566[_loc3_].length)
                  {
                     repositionWindow(var_566[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
