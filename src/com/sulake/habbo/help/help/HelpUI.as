package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1777:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24424-24421-201001141019");
         var_187 = param5;
         var_111 = new Map();
         var_111.add(HabboHelpViewEnum.const_1223,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_149,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_459,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_263,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_188,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_543,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_281,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_699,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_194,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_111.add(HabboHelpViewEnum.const_878,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_654,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_255 == HabboHelpViewEnum.const_149 || false)
         {
            return;
         }
         if(var_384 == null)
         {
            ...
            var_384 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_384 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_384 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_384 as IWindow);
      ...
      {
         return var_111.getValue(var_255);
      }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_194:
               ...
               break;
            case CallForHelpResultEnum.const_934:
               showUI(HabboHelpViewEnum.const_878);
               break;
            case CallForHelpResultEnum.const_983:
      ...
      {
         var _loc3_:* = null;
         if(var_255 == HabboHelpViewEnum.const_149)
         {
            return;
         }
         if(true)
         {
            ...
            var_526.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_526.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_384.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_526[1],var_526[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_526[0],var_526[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1397;
         _window.width = _loc1_.width + var_1396;
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_44.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_716));
      }
