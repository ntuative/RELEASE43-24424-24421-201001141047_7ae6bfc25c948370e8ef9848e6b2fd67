package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_743:String = "selection_arrow";
      
      private static const const_742:String = "tile_cursor";
      
      private static const const_271:String = "RCL_PUBLICROOM_";
      
      private static const const_481:String = "wall_place_holder";
      
      private static const const_1033:int = 2;
      
      private static const const_331:String = "place_holder";
      
      private static const const_1032:String = const_331;
      ...
      public static const const_608:String = "RCL_LOADER_READY";
      ...
      private var var_889:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_601 = [];
         _wallItems = [];
         var_1561 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1562 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_369 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_509.getValue(param1) as String;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_368 != null)
         {
            _loc2_ = var_368.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_113 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_166 != null && var_166.hasWorldType(const_271 + param1))
         {
            return var_166.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_601.indexOf(_loc14_) < 0)
                              {
                                 var_601.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_509.add(_loc10_,_loc11_);
                              if(_wallItems.indexOf(_loc14_) < 0)
                              {
                                 _wallItems.push(_loc14_);
                              }
                           }
                           _loc16_ = var_432.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_432.remove(_loc14_);
                              var_432.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_369 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_369.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_320 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_320.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_331,const_481,ROOM_CONTENT,const_742,const_743];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_369.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_508.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_369.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_33 || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_432.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1561.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_156 && _loc5_ != RoomObjectLogicEnum.const_113)
         {
            _loc6_ = "@shadow";
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_367 != null)
         {
            _loc2_ = var_367.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1265);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_509.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1562.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_454,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_355,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_1563)
         {
            ...
            if(var_889 != null)
            {
               var_889.dispatchEvent(new Event(const_608));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_166 != null)
         {
            return var_166.getWorldHeightScale(const_271 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_889 = param1;
            var_1564 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1559 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1558 = param2.getKey("public.room.dynamic.download.url","");
            var_1560 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_744;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_320.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_367 != null)
         {
            var_367.remove(param1);
            var_367.add(param1,param2);
         }
         if(var_368 != null)
         {
            var_368.remove(param2);
            var_368.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_156 && _loc5_ != RoomObjectVisualizationEnum.const_113)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_376.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_320.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(getObjectCategory(const_271 + param1) == RoomObjectCategoryEnum.const_57)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_166 = _publicRooms.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_166 != null)
         {
            return var_166.getWorldScale(const_271 + param1);
         }
         return 32;
      }
