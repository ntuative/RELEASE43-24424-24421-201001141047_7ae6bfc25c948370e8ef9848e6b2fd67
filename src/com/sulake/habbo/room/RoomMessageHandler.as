package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_890:int = -1000000000;
      
      private var var_1066:Boolean = true;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_960,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_706);
         var _loc8_:int = 0;
         while(_loc8_ < _loc3_.userUpdateCount)
         {
            _loc9_ = _loc3_.method_8(_loc8_);
            if(_loc9_ != null)
            {
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new ItemsMessageEvent(method_6));
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_910:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_789:
                     _loc10_ = "std";
               }
