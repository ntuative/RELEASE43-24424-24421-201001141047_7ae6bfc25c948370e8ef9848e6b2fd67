package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_522 = new Vector3d();
         var_522.assign(param2);
         var_521 = new Vector3d();
         var_521.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1698)
         {
            if(!param1)
            {
               var_249.assign(var_522);
               var_250.assign(var_521);
            }
            else
            {
               var_249.assign(var_522);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_74 == null && var_695 != null || var_249 == null || var_250 == null || var_416 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1116)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_923 || _loc4_.y != var_1697 || _loc4_.z != var_1700 || param1.scale != var_1699))
            {
               ...
               _loc6_ = param1.getScreenPosition(var_695);
               _loc7_ = _loc6_.z;
