package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_468:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_468 = var_266.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_468 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_266 != null)
         {
            ...
            {
               _loc1_ = var_266.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_266.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_266.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
