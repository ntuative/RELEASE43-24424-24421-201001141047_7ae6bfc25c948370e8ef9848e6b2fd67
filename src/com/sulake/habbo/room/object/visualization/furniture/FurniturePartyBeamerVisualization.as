package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_759:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_963[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_962[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_963 = new Array();
         var_963.push(Math.random() * _loc2_ * 1.5);
         var_963.push(Math.random() * _loc2_ * 1.5);
         var_960 = new Array();
         var_960.push(1);
         var_960.push(-1);
         var_961 = new Array();
         var_961.push(const_1077);
         var_961.push(const_1076);
         var_962 = new Array();
         var_962.push(getRandomAmplitudeFactor());
         var_962.push(getRandomAmplitudeFactor());
      }
