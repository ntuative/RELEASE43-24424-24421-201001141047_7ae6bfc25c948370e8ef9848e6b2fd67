package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1164:int = const_294;
      ...
      public static const const_235:int = const_101;
      ...
      private var var_762:Vector3d = null;
      
      private var _columns:Array;
      
      private var var_1122:Boolean = true;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1722 = param6;
         var_1721 = param7;
         var_762 = new Vector3d();
         if(var_1377 == const_637)
         {
            var_1122 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1378 == const_101)
         {
            _loc5_ = new Rectangle(0,0,var_40.width,var_446);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_446,var_40.width,var_446);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_40 != null)
            {
               if(var_40.width == param2 && var_40.height == param3 && Vector3d.isEqual(var_762,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_446,param6,param7);
                     return param1;
                  }
                  return var_40;
               }
