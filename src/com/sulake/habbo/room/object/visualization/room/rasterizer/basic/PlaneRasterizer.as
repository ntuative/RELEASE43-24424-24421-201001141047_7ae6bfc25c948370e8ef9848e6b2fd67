package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_733:String = "WindowMouseOperator";
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_171.getValue(_loc6_) == null)
               {
      ...
      public function dispose() : void
      {
         ...
         if(var_171 != null)
         {
            ...
            {
               _loc3_ = var_171.getWithIndex(_loc1_) as PlaneTexture;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return var_171.getValue(param1) as PlaneTexture;
      }
