package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1308:int = 10066329;
      
      private static const const_1078:int = 13421772;
      ...
      private static const const_1079:int = 10066329;
      
      private static const const_1080:int = 10066329;
      
      public static const const_1199:int = 13421772;
      ...
      private var var_1861:String = null;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_106.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1420;
               }
               if(var_84.getPlaneType(_loc4_) == RoomPlaneData.const_147)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_84.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_227)
            {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_674);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_719);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_669);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_806);
            if(_loc8_ != var_1861)
            {
               updatePlaneMasks(_loc8_);
               var_1861 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_602));
            if(_loc9_ != var_967)
            {
               var_967 = _loc9_;
            }
            var_1860 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_792));
         ...
         while(_loc4_ < var_106.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_177)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         while(_loc7_ < var_84.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_227)
            {
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_106.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_269 || _loc3_.type == RoomPlane.const_177 && _loc8_ == RoomPlaneBitmapMaskData.const_190)
                  {
