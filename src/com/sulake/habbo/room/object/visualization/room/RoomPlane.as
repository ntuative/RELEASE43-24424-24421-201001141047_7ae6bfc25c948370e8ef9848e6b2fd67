package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_556:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         super();
         var_2144 = param8;
         var_695 = new Vector3d();
         var_695.assign(param1);
         var_74 = new Vector3d();
         ...
         var_416 = Vector3d.crossProduct(var_249,var_250);
         if(false)
         {
            var_416.mul(Infinity);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_269 || _type == const_177))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_859 || false && false && !var_162 || var_556 == null)
         {
            return;
         }
         ...
         if(var_65 == null || var_65.width != _loc7_ || var_65.height != _loc8_)
         {
            if(var_65 != null)
            {
               var_65.dispose();
            ...
            var_65 = new BitmapData(_loc7_,_loc8_,true,16777215);
            var_162 = true;
         }
         if(var_162)
         {
            ...
            if(var_65 != null)
            {
               var_65.fillRect(var_65.rect,16777215);
            }
            resetTextureCache(param1);
            _loc9_ = param2.getCoordinatePosition(var_416);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_207.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_556.updateMask(var_65,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < var_279.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_65.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
         ...
         combineTextureMask(param1,var_65);
      }
      ...
      private function getTextureIdentifier(param1:IRoomGeometry) : String
      {
         ...
         if(var_696 != null)
         {
            _loc2_ = var_696.getTextureIdentifier(param1.scale,normal);
         }
         return _loc2_;
      }
      ...
      {
         if(var_129 == null || var_109 == null || var_83 == null || var_108 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_269 || _type == const_177)
         {
      ...
      {
         var_129.assign(param1.getScreenPosition(var_74));
         var_109.assign(param1.getScreenPosition(Vector3d.sum(var_74,var_250)));
         var_83.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_74,var_249),var_250)));
         var_108.assign(param1.getScreenPosition(Vector3d.sum(var_74,var_249)));
         _offset = param1.getScreenPoint(var_695);
         ...
         var _loc2_:Number = Math.min(var_129.x,var_109.x,var_83.x,var_108.x);
         var _loc3_:Number = Math.max(var_129.x,var_109.x,var_83.x,var_108.x);
         var _loc4_:Number = Math.min(var_129.y,var_109.y,var_83.y,var_108.y);
         var _loc5_:Number = Math.max(var_129.y,var_109.y,var_83.y,var_108.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_129.x = 0 - _loc2_;
         var_109.x = 0 - _loc2_;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc10_:* = null;
         if(param1 == null || var_695 == null || var_74 == null || var_249 == null || var_250 == null || var_416 == null)
         {
            return false;
         }
         var _loc3_:Boolean = false;
         if(param1.updateId != var_1116)
         {
            var_1116 = param1.updateId;
            _loc4_ = param1.direction;
            if(_loc4_ != null && (_loc4_.x != var_923 || _loc4_.y != var_1697 || _loc4_.z != var_1700 || param1.scale != var_1699))
            {
               var_923 = _loc4_.x;
               var_1697 = _loc4_.y;
               var_1700 = _loc4_.z;
               var_1699 = param1.scale;
               _loc3_ = true;
               _loc5_ = 0;
               ...
               _loc6_ = 0;
               while(_loc6_ < var_1285.length)
               {
                  _loc5_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1285[_loc6_]));
                  if(_loc5_ > -0.001)
                  {
                     if(_isVisible)
                     {
               ...
               _loc7_ = param1.getScreenPosition(var_695);
               _loc8_ = _loc7_.z;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc7_ = param1.getCoordinatePosition(var_416);
            ...
            if(var_696 != null)
            {
               _loc4_ = var_696.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1519,var_2145,var_2147,var_2148,var_2146,param2);
               if(_loc4_ != null)
               {
