package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1557:int = 16777216;
      
      public static const const_1536:int = 1;
       
      
      private var var_2263:int = 69069;
      
      private var var_1094:int = 1;
      
      private var var_2262:int = 5;
      
      private var var_1357:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1357 * param2);
      }
      ...
      {
         var _loc1_:int = var_2263 * var_1094 + var_2262;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
