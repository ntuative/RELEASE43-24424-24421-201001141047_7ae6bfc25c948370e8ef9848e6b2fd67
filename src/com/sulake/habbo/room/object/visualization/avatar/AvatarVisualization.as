package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1404:int = 0;
      
      private var var_559:String;
      
      private var var_590:int = 0;
      
      private const const_1613:int = 1;
      
      private var _assetLibrary:AssetLibrary = null;
      
      private var var_1150:Number;
      ...
      private const const_1058:int = 3;
      
      private const const_1612:int = 2;
      
      private var var_776:AvatarVisualizationData = null;
      ...
      {
         var_776 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = var_402.getValue(_loc4_) as IAvatarImage;
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_155);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_611);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_670);
         ...
         var _loc13_:Number = _loc7_ - var_1150;
         if(_loc13_ > 5000 && _loc5_ != null && _loc5_.getScale() == AvatarScaleType.const_51)
         {
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_291);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_280 != _loc2_.getUpdateID() || var_210 != param1.scale || var_185 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_452 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_452;
            _loc22_ = getTimer();
            if(var_559 != _loc6_)
            {
               for each(_loc48_ in var_402.getKeys())
               {
                  var_402.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            {
               _loc5_ = var_776.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
               var_402.remove(_loc4_);
               var_402.add(_loc4_,_loc5_);
               var_559 = _loc6_;
            }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_322);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_249) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_249);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_667);
            _loc5_.appendAction(AvatarAction.const_638,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_417);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_51)
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_308,AvatarAction.const_1180[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_877);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_876,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_901);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_854);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_1006,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_620);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_830,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_890);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_987,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_469);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_432) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_588);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_396);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_895);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_557,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1612);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_886))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_776.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_280 = _loc2_.getUpdateID();
            var_185 = _loc3_.getUpdateID();
            var_210 = param1.scale;
            var_775.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_775)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_402 != null)
         {
            _loc1_ = var_402.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_402.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
