package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_776:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc11_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_781);
         if(_loc11_ > 0)
         {
            _loc16_ = getTimer() - _loc11_;
            if(_loc16_ < AvatarAction.const_945)
            {
               _loc9_ = uint(int(Math.sin(Number(_loc16_) / 0 * 0) * 255));
               _loc10_ = _loc3_.getNumber(RoomObjectVariableEnum.const_790);
               var_452 = const_1058;
            }
         }
         var _loc12_:Boolean = false;
         var _loc13_:String = _loc3_.getString(RoomObjectVariableEnum.const_249);
         switch(_loc13_)
         {
         ...
         var _loc14_:Boolean = var_280 != _loc2_.getUpdateID() || var_210 != param1.scale || var_185 != _loc3_.getUpdateID();
         var _loc15_:Boolean = _isAnimating || var_452 > 0 || _loc12_;
         if(_loc14_ || _loc15_)
         {
            _loc17_ = getTimer();
            --var_452;
            if(var_559 != _loc6_)
            {
               for each(_loc35_ in var_402.getKeys())
               {
                  var_402.remove(_loc35_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            ...
            _loc19_ = _loc3_.getNumber(RoomObjectVariableEnum.const_322);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc20_ = _loc3_.getString(RoomObjectVariableEnum.const_249);
            _loc21_ = _loc3_.getString(RoomObjectVariableEnum.const_667);
            _loc5_.appendAction(AvatarAction.const_638,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
            ...
            _loc23_ = _loc3_.getString(RoomObjectVariableEnum.const_417);
            if(_loc23_ != null && _loc23_ != "")
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_308,_loc23_);
               }
            }
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_432) > 0;
            if(_loc24_)
            {
            ...
            _loc30_ = getSprite(const_1612);
            if(_loc9_ > 0)
            {
               _loc28_ = null;
               _loc28_ = var_776.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc28_ != null)
               {
            ...
            var_775.push(getTimer() - _loc17_);
            if(false)
            {
               _loc55_ = 0;
               _loc56_ = "[";
               for each(_loc57_ in var_775)
               {
                  _loc55_ += _loc57_;
                  _loc56_ += "," + _loc57_;
               }
      ...
      {
         var_776 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
