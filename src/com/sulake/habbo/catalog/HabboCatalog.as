package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_228:IMarketPlace;
      ...
      private var var_342:ICatalogViewer;
      ...
      private var var_1971:GiftWrappingConfiguration;
      ...
      {
         return var_530.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_200.credits = _loc3_.balance;
         updatePurse();
         if(!var_1970 && var_782 != null)
         {
            var_782.playSound(HabboSoundTypesEnum.const_909);
         }
         var_1970 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_530.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_74)
         {
            _loc3_ = var_530.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               var_1222 = param1.session.isPrivateRoom;
               if(var_89 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1971 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_200.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_200.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createMarketPlace() : void
      {
         if(var_228 == null)
         {
            var_228 = new MarketPlaceLogic(this,_windowManager);
         }
      }
      ...
      {
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      {
         if(param1 == null || var_342 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_342.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_200.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_200.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_200.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_200.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_342.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_200.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1972 && var_782 != null)
         {
            var_782.playSound(HabboSoundTypesEnum.const_988);
         }
         var_1972 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_342.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_342.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_342 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
