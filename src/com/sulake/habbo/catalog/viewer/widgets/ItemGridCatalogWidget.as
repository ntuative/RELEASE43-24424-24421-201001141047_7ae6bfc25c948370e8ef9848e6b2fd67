package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_742 >= 0 && var_742 < page.offers.length)
            {
               _loc4_ = page.offers[var_742];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_384)
         {
            ++var_1356;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1356);
         }
      }
      
      override public function init() : void
      {
         var_872 = _window.findChildByName("itemGrid") as IItemGridWindow;
