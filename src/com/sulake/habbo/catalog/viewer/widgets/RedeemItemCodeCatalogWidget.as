package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_900:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_900 != null)
         {
            var_900.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_899 != null)
         {
            var_899.removeEventListener(WindowKeyboardEvent.const_114,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_900 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_900 != null)
         {
            var_900.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_899 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_899 != null)
         {
            var_899.addEventListener(WindowKeyboardEvent.const_114,windowKeyEventProcessor);
         }
      }
