package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1247:String = "WindowMouseOperator";
      ...
      private var var_997:BitmapData = null;
      ...
      private var _floorType:String = "WindowMouseOperator";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_996 != null && var_997 != null)
         {
            setRoomImage(var_996,var_997);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_177.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_229 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_229];
                  if(_loc9_ != null)
                  {
                     var_1247 = _loc9_.@id;
                  }
         ...
         switch(param1)
         {
            ...
            case const_176:
               ...
               for each(_loc9_ in var_177.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_664 = _loc9_.children().length();
                  }
               }
            ...
            case const_177:
               ...
               for each(_loc10_ in var_177.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_665 = _loc10_.children().length();
                  }
               }
