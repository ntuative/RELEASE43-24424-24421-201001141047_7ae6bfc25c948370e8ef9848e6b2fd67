package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1015:ITextFieldWindow;
      ...
      {
         super.init();
         var_1015 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1015 != null)
         {
            var_1015.addEventListener(WindowKeyboardEvent.const_646,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1015.text));
      }
   }
}
