package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private function updateList(param1:Map) : void
      {
         ...
         updateStatusDisplay(const_1391,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc9_ = _loc6_[_loc7_];
            _loc10_ = param1.getValue(_loc9_) as MarketPlaceOfferData;
            if(_loc10_.status == MarketPlaceOfferState.const_427)
            {
               _loc5_ = true;
            }
            ...
            if(_loc4_)
            {
               ...
               if(!(!_loc11_ || _loc11_.disposed))
               {
                  ...
                  if(_loc10_.status == MarketPlaceOfferState.const_856)
                  {
                  ...
                  if(_loc10_.status == MarketPlaceOfferState.const_949)
                  {
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_856,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_427,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_949,_loc2_);
            }
         }
