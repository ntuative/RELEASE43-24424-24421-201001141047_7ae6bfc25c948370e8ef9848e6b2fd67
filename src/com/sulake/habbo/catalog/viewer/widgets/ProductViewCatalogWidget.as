package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1109:IScrollbarWindow;
      
      protected var var_1306:XML;
      
      private var var_1110:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1203.text = "${" + _loc3_.name + "}";
            var_1204.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1203.text = "${" + _loc2_.localizationId + "}";
            var_1204.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_384:
                  _loc4_ = var_1110.clone();
                  if(var_519 != null)
                  {
                     var_519.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_519,var_1109,var_1306);
                  }
                  break;
               case Offer.const_418:
               case Offer.const_345:
                     ...
                     case ProductTypeEnum.const_215:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_308,AvatarAction.const_530);
                              _loc13_.appendAction(AvatarAction.const_557,_loc6_.productClassId);
      ...
      {
         var_1203 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1204 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1369 = new Point(var_87.x,var_87.y);
         var_519 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1109 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_519 == null)
         {
         ...
         var_1110 = _loc2_.content as BitmapData;
