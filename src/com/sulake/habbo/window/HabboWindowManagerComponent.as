package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1061:uint = 1;
      ...
      private var var_1156:ProfilerAgentTask;
      
      private var var_1154:IEventDispatcher;
      
      private var var_2284:uint = 0;
      
      private var var_1155:ProfilerAgentTask;
      
      private var var_1153:ProfilerOutput;
      
      private var var_636:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1154 = Component(param1).events;
            var_783 = new Array();
      ...
      {
         return var_285[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_285[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_636 = new WindowRenderer(_loc4_);
         var_285 = new Array(const_335);
         var _loc6_:int = 0;
         while(_loc6_ < const_335)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_636,this,_localization,var_188,new Rectangle(0,0,var_188.stageWidth,var_188.stageHeight),this);
            var_285[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_414 = var_285[const_1061];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_414.getMouseCursor().defineCustomCursorType(MouseCursorType.const_287,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_414.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1193,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_285[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_285.pop()).dispose();
            }
            if(var_1153 != null)
            {
               var_1153.dispose();
      ...
      {
         return var_285[param1].getDesktopWindow().getChildAt(var_414.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1153 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1153 = new ProfilerOutput(_loc3_,this,var_636);
               var_1156 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1156);
               var_1155 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1155);
               var_948 = true;
            }
         }
      }
      ...
      {
         return var_414.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_868.length > 0)
         {
            var_1154.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_335 - 1;
            while(_loc2_ >= 0)
            {
               var_285[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_948)
         ...
         var_1154.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_335)
         {
            var_285[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_948)
         {
         ...
         if(WindowContext.var_868.length > 0)
         {
            WindowContext.var_868.flush();
         }
         if(WindowContext.var_1300.length > 0)
         {
            WindowContext.var_1300.flush();
         }
         var_1154.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_783[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_783[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_414.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1290,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1173,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1210,new Date().getTime().toString());
