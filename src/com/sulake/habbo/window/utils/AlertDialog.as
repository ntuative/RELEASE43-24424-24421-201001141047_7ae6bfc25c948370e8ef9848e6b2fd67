package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static var var_590:uint = 0;
      ...
      public function set description(param1:String) : void
      {
         ...
         if(_window)
         {
            ITextWindow(_window.findChildByTag("DESCRIPTION")).text = var_1067;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  if(var_183 != null)
                  {
                     var_183(this,new WindowEvent(WindowEvent.const_157,null,null));
                  }
                  break;
               case "header_button_close":
                  if(var_183 != null)
                  {
                     var_183(this,new WindowEvent(WindowEvent.const_568,null,null));
                  }
            }
         }
      }
