package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements ICoreUpdateReceiver
   {
      ...
      public static const const_422:int = 4;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            var_1199 = 0 - _loc7_.rectangle.bottom;
         }
         else
         {
            var_1199 = 15;
         }
         var_1439 = _window.height;
         var_557 = 4;
         var_395 = 0;
         _state = const_337;
         var_187 = param5;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _window.height = 0;
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + var_1199;
         if(_window.height < var_1439)
         {
            _window.height = var_1439;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(_state)
         {
            ...
            case const_375:
               var_811 += param1;
               _loc2_ = Number(var_811) / Number(var_394["time_fade_in"]);
               if(var_811 > int(var_394["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_762:
               var_983 += param1;
               if(var_983 > int(var_394["time_display"]) && !var_1198)
               {
                  startFadeOut();
               }
               break;
            case const_763:
               var_810 += param1;
               _loc3_ = 1 - Number(var_810) / Number(var_394["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_810 > int(var_394["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_187.orientation == "TOP" ? int(const_338) : 0;
         var _loc4_:int = var_187.orientation == "BOTTOM" ? int(_loc2_.height - const_338) : int(_loc2_.height);
         var _loc5_:int = var_187.orientation == "LEFT" ? int(const_338) : 0;
         var _loc6_:int = var_187.orientation == "RIGHT" ? int(_loc2_.width - const_338) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
               _window.x = _loc5_ + const_422;
            }
            else
            {
               _window.x = _loc6_ - 0 - const_422;
            }
         }
         else if(false)
         {
