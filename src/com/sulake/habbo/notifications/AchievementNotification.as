package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_203 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1979 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_203);
      ...
      public function dispose() : void
      {
         if(var_530 != null)
         {
            var_530.events.removeEventListener(BadgeImageReadyEvent.const_128,onBadgeImageReady);
            var_530 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_661,var_1979);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_661,var_661));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_661,var_661));
         _localizations.registerParameter(param1,"level",var_1608.toString());
         _localizations.registerParameter(param1,"name",var_530.userName);
         _localizations.registerParameter(param1,"realname",var_530.realName);
      }
   }
}
