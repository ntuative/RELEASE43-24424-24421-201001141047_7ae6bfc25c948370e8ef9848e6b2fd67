package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements ICoreUpdateReceiver
   {
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_491;
         var _loc2_:int = 0;
         while(_loc2_ < var_237.length)
         {
            _loc3_ = var_237[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_516 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_516 + const_491;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_2116,var_394,var_187);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_516 < 540;
      }
   }
}
