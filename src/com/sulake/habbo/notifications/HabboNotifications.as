package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1069:String = "pixelbalance";
      
      private static const const_1065:String = "credits";
      
      private static const const_1071:String = "inventory";
      
      private static const const_1070:String = "friendlist";
      
      private static const const_1067:String = "selectfurni";
      
      private static const const_1066:String = "selectbadge";
      ...
      private var var_1171:IHabboToolbar;
      ...
      private var var_194:HabboAlertDialogManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_790);
         }
         var _loc6_:Map = var_790["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1269);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_845)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1264);
         }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_194 == null)
         {
            return;
         }
         var_194.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_194.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_194.method_10(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1266);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1831)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_863);
            var_1831 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1162.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_965,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_157 || param2.type == WindowEvent.const_568)
         {
            param1.dispose();
         }
      }
      ...
      {
         var _loc1_:Array = var_952.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1162.createPetImage(_loc2_.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_530);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc15_.productType == CatalogPageMessageProductData.const_76)
               {
                  _loc16_ = var_530.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_74)
               {
                  _loc16_ = var_530.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_530.getProductData(_loc4_.localizationId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_863,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1162.createAvatarImage(param2,AvatarScaleType.const_51);
         if(_loc7_ != null)
         {
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_194.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      {
         var_1171 = IHabboToolbar(param2);
         var_1171.events.addEventListener(HabboToolbarEvent.const_80,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_189);
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_194 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_530.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_1007);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_1007);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_194.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_80)
         {
            ...
            var_387 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_790["styles"],var_790["view"],var_1171);
            ...
            var_530.events.addEventListener(BadgeImageReadyEvent.const_128,onBadgeImage);
            var_1171.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
