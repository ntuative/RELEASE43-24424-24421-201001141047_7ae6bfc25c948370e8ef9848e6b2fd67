package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private var var_1201:LagWarningLogger = null;
      
      private var var_813:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_224 = new PerformanceTracker();
         var_225 = new LatencyTracker();
         var_1201 = new LagWarningLogger();
         var_1200 = new Array(const_764);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1222,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1344,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1182,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_723,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_858,String(0));
         }
      ...
      {
         var_88 = IHabboCatalog(param2) as IHabboCatalog;
         var_88.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_88.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_88.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_177)
         {
            Component(var_177).events.addEventListener(HabboConfigurationEvent.const_19,onConfigurationLoaded);
            if(var_225 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_454.events.addEventListener(AdEvent.const_438,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_858,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_723,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_647,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_61,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_409,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_450:
               var_1201.registerWarning(LagWarningLogger.const_839);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_813)
            {
               var_813.release(new IIDHabboWindowManager());
               var_813 = null;
            }
            if(var_454)
            {
            ...
            if(var_88)
            {
               if(true)
               {
                  var_88.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_88.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_88.release(new IIDHabboCatalog());
               var_88 = null;
            }
            if(var_25)
            {
            ...
            if(var_176)
            {
               if(true)
               {
                  ...
                  Component(var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_288,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_450,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_177)
         {
            Component(var_177).events.removeEventListener(HabboConfigurationEvent.const_19,onConfigurationLoaded);
         }
      }
      ...
      {
         var_813 = IHabboWindowManager(param2);
         if(var_813)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_984 > -1 && _loc2_ < var_984)
         {
            ++var_1440;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1440);
         }
         if(var_984 > -1 && _loc2_ - var_984 > 15000)
         {
            ++var_1441;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1441);
         }
         var_984 = _loc2_;
         if(var_224 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_450,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_176).events.addEventListener(HabboFriendListTrackingEvent.const_288,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_1920)
         {
            var_1920 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1295,new Date().getTime().toString());
            if(var_177)
            {
               if(var_177.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_224 != null)
                  {
                     _loc4_["null"] = var_224.flashVersion;
                     _loc4_["null"] = var_224.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_647)
         {
            trackLoginStep(HabboLoginTrackingStep.const_21);
         }
         else if(param1.type == HabboHotelViewEvent.const_409)
         {
