package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1365 = getTimer();
         var_440.add(var_1100,var_1365);
         _connection.send(new LatencyPingRequestMessageComposer(var_1100));
         ++var_1100;
      }
      ...
      public function init() : void
      {
         ...
         var_1363 = int(var_177.getKey("latencytest.interval"));
         var_1364 = int(var_177.getKey("latencytest.report.index"));
         var_1680 = int(var_177.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_151.push(_loc4_);
         if(var_151.length == var_1364 && var_1364 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1366) > var_1680 || var_1366 == 0)
            {
               var_1366 = _loc9_;
