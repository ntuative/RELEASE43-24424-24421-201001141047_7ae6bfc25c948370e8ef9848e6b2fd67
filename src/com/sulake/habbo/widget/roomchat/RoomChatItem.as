package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private var var_190:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_933,var_931,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_933,var_931,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1135 = param1.chatType;
         var_933 = param1.userId;
         var_772 = param1.userName;
         var_931 = param1.userCategory;
         _message = param1.text;
         var_1134 = param1.userX;
         var_190 = param1.userImage;
         var_932 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_92,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         switch(var_1135)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_99:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_223:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_267:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_190 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_190.height);
         }
         ...
         if(var_190 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_190.width;
               _loc28_.height = var_190.height;
               _loc28_.bitmap = new BitmapData(var_190.width,var_190.height,true,0);
               _loc28_.bitmap.copyPixels(var_190,var_190.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_381 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_190.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_932 != 0)
            {
               _loc31_ = uint(var_932 >> 16 & 255);
               _loc32_ = uint(var_932 >> 8 & 255);
               _loc33_ = uint(var_932 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1135 == RoomWidgetChatUpdateEvent.const_223)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_772);
            }
            else if(var_1135 == RoomWidgetChatUpdateEvent.const_267)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_772);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_332 + _loc20_.textWidth + const_486;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_933,var_931,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_933,var_931,_roomId,_roomCategory,param1);
      }
