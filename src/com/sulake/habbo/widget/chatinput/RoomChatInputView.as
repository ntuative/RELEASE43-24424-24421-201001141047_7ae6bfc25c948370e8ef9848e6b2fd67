package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1397:int = 5;
      ...
      private static const const_1041:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_901 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1596 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1595 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_608 = new Timer(1000,1);
         var_608.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_730 = new Timer(5000,1);
         var_730.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_114,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_165,onInputChanged);
         _window.addEventListener(WindowEvent.const_411,onWindowMoved);
         var_1083 = true;
         var_127 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1594 = _loc2_.width + const_486 + _loc6_.width + const_1042;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1041,_loc8_.width) + const_486);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_901 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_127 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_435);
