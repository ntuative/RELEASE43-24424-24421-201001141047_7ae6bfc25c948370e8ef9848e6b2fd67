package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_415:String = "CPV_MODE_TRIAL";
      
      public static const const_1366:String = "CPV_MODE_FULL";
      ...
      private const const_1057:String = "avatareditor_club_promo_image";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_ = _widget.assets.loadAssetFromFile(const_1057,_loc7_,"image/png");
      ...
      {
         _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_711));
      }
      ...
      private function setPromoImage() : Boolean
      {
         ...
         if(_widget.assets.hasAsset(const_1057))
         {
            _loc2_ = _widget.assets.getAssetByName(const_1057) as BitmapDataAsset;
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_605,_loc2_.text,var_687 == const_415);
