   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_739 = _window.findChildByName("effect_hilite");
            var_739.visible = false;
         }
         var_741 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_740 = _window.findChildByName("loader_bar");
         if(var_740 != null)
         {
            var_390 = var_740.width;
            var_169.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_741 != null)
         {
            var_741.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_741.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
