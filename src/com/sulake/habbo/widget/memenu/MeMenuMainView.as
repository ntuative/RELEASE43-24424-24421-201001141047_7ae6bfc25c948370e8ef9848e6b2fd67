      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_828));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_515);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_935));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_244);
               break;
            case "hc":
