package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1409:String = "infostand_user_view";
      
      private var var_295:InfoStandPetView;
      
      private var var_1063:InfoStandPetData;
      ...
      private const const_1411:String = "infostand_pet_view";
      ...
      private var var_366:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         var_198 = new InfoStandUserView(this,const_1409);
         var_295 = new InfoStandPetView(this,const_1411);
         var_337 = new InfoStandBotView(this,const_1412);
         var_366 = new InfostandUserData();
         var_403 = new InfostandFurniData();
         var_1063 = new InfoStandPetData();
         var_135 = new Timer(const_1619);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_198.setTags(param1.tags,var_1929);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_675,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_537,onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_131,onPetInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_374,var_295.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_675,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_537,onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_131,onPetInfo);
