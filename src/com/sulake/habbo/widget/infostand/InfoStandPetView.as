package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1608:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1604:String = "level";
      ...
      private const const_1607:String = "nutrition";
      
      private var var_66:IItemListWindow;
      
      private const const_1605:uint = 3355443;
      
      private var var_215:IBorderWindow;
      
      private const const_1606:int = 158;
      ...
      private const const_1610:uint = 11184810;
      
      private const const_1611:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_215 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_215 != null)
         {
            var_110 = var_215.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_215.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         _loc4_ = 0;
         while(_loc4_ < var_66.numListItems)
         {
            _loc9_ = var_66.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc9_ != null)
            {
         ...
         var _loc6_:IBitmapWrapperWindow = var_215.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:* = [];
         var_66.groupListItemsWithTag("CMD_BUTTON",_loc7_,true);
      ...
      private function method_1(param1:String, param2:int, param3:int) : void
      {
         var _loc7_:* = null;
         if(var_110 == null)
         {
      ...
      {
         if(var_110 == null || var_215 == null || var_66 == null)
         {
            return;
         }
         ...
         var_215.height = NaN;
         _window.width = Math.max(var_215.width,var_66.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1063.getValue(var_699) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         method_1(const_1604,param1.level,param1.levelMax);
         method_1(const_1611,param1.experience,param1.experienceMax);
         method_1(const_1609,param1.energy,param1.energyMax);
         method_1(const_1607,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_699 = param1.id;
         var_1063.remove(param1.id);
         var_1063.add(param1.id,param1);
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = var_66.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_346,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1606,const_1603,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1610);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1605);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1608);
         return _loc5_;
      }
