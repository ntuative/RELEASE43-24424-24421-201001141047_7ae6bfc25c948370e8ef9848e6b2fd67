package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_98 && param1.type != WindowMouseEvent.const_604)
         {
            return;
         }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_534 != null)
            {
               ...
               var_1406 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1406 * (Number(param1 - var_639) / (var_950 - var_639)));
      }
      ...
      {
         return int(param1 / var_1406 * (var_950 - var_639)) + var_639;
      }
   }
}
