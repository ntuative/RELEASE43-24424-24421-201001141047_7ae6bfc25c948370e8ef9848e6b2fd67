package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_323:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1037,const_1038,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_323 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_323 != null)
         {
            var_323.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_898 = _loc2_.light;
         if(var_323 != null)
         {
            var_323.setValue(var_898);
         }
         var_365 = colors.indexOf(_loc2_.color);
         if(var_434 != null)
         {
            var_434.setSelectedColorIndex(var_365);
         }
