package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private var var_235:Boolean = false;
      ...
      {
         var _loc1_:* = null;
         if(var_235 || var_159 == -1 || !_controller)
         {
            return;
         }
         var_235 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_672,var_159);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1037,const_1038,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_203 != null)
         {
            _loc6_.caption = var_203;
         }
