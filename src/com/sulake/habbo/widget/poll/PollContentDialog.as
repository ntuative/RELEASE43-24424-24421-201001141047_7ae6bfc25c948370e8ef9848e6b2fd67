package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_604[var_894] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_284)
         {
            ...
            var_284 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_284.center();
            var_284.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_894;
         if(var_894 < var_604.length)
         {
            _loc1_ = var_604[var_894] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_604.length);
                  _loc2_.text = _loc6_;
               }
