package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_2128:BitmapData = null;
      ...
      private var var_2129:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_438,0,0,_loc4_,var_1507,var_2129,var_2128));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2126 = int(_config.getKey("interstitial.interval","30000"));
         var_2125 = int(_config.getKey("interstitial.show.time","5000"));
         var_1509 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1275 = _loc2_.imageUrl;
         var_1507 = _loc2_.clickUrl;
         if(var_1275 != "" && var_1507 != "")
         {
            _loc3_ = var_1275;
            ...
            _loc4_ = new URLRequest(var_1275);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_445,0,0,param1.bitmapData,var_2127));
            var_683 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2128 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1509 > 0 && var_1508 >= var_1509)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_683;
         if(_loc1_ > var_2126)
         {
            ++var_1508;
      ...
      {
         var_697 = param2 as IHabboCommunicationManager;
         if(var_697 == null)
         {
            return;
         }
         _connection = var_697.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2129 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
