package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1598:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_53.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_53.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_35 != null)
         {
            var_35.events.removeEventListener(RoomSessionEvent.const_89,roomSessionEventHandler);
            var_35.events.removeEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
            var_35.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_465,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_53.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_95:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_465:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_53.getValue(InventoryCategory.const_625));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_53.getValue(InventoryCategory.const_71));
      }
      ...
      {
         var_200.clubPeriods = param1;
         var_200.clubDays = param2;
         var_200.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_932));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_53.getValue(InventoryCategory.const_154));
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_53.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:IInventoryModel = var_53.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1598);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_53.getValue(InventoryCategory.const_328));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_715.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_715.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = var_53.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_53.length)
         {
            _loc3_ = var_53.getWithIndex(_loc2_) as IInventoryModel;
      ...
      {
         return TradingModel(var_53.getValue(InventorySubCategory.const_226));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_530 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_715.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_200.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_53.getValue(InventoryCategory.const_388) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1324 = new IncomingMessages(this);
      ...
      {
         return var_200.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_200.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_53.getValue(InventoryCategory.const_264));
      }
      ...
      {
         var_35 = IRoomSessionManager(param2);
         var_35.events.addEventListener(RoomSessionEvent.const_89,roomSessionEventHandler);
         var_35.events.addEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
         var_35.events.addEventListener(RoomSessionPropertyUpdateEvent.const_465,roomSessionEventHandler);
         ...
         var_53.add(InventoryCategory.const_388,_loc3_);
         ...
         var_53.add(InventoryCategory.const_71,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_530);
         var_53.add(InventoryCategory.const_264,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_53.add(InventoryCategory.const_625,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_530);
         var_53.add(InventoryCategory.const_328,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_53.add(InventorySubCategory.const_226,_loc8_);
         var _loc9_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_53.add(InventorySubCategory.RECYCLER,_loc9_);
         ...
         var_53.add(InventoryCategory.const_154,_loc10_);
