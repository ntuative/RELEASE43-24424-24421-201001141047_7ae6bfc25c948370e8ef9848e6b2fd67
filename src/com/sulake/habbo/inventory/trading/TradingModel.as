package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_305:uint = 2;
      
      public static const const_393:uint = 4;
      ...
      public static const const_214:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_453 = false;
         var_634 = false;
         var_54.updateItemList(var_633);
         var_54.updateItemList(var_1151);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_54.alertPopup(TradingView.const_859);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_633)
            {
               var_453 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_634 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_54.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_633)
            {
               var_54.alertPopup(TradingView.const_964);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_453 + " OTHER: " + var_634);
         ...
         {
            case const_166:
               if(param1 == const_167 || param1 == const_214)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_54.setMinimized(param1 != InventoryCategory.const_71);
      ...
      public function close() : void
      {
         if(var_570)
         {
            if(_state != const_166 && _state != const_214)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_166;
            var_25.toggleInventorySubPage(InventorySubCategory.const_810);
            var_570 = false;
         }
         var_54.setMinimized(false);
      }
