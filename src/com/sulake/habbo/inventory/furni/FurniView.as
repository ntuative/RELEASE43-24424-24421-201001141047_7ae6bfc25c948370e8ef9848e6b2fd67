package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_924:MarketplaceModel;
      
      private var var_444:Map;
      
      private var var_443:String;
      
      private const const_1629:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_444 = new Map();
         var_444.add(FurniModel.const_41,new FurniGridView(var_93,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         var_444.add(FurniModel.const_42,new FurniGridView(var_93,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  var_93.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  var_93.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  var_93.requestSelectedFurniSelling();
                  break;
               default:
         ...
         else if(param1.type == WindowEvent.const_53)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_296);
            }
         }
      }
      ...
      {
         var _loc3_:GroupItem = var_93.getGroupItemInIndex(var_93.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_444.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_444.getValue(var_443);
         if(_loc4_ != null)
         {
         ...
         var_93.furniCategorySwitch(param1);
      }
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_444.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = var_93.getSelectedItemIndex();
         _loc4_ = var_93.getGroupItemInIndex(_loc3_,var_443);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_309)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && var_93.canUserOfferToTrade())
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_924 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_444.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
