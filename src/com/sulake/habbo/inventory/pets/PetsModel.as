package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_154 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1270 && param1.type == RoomEngineObjectEvent.const_191)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1270 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_275,_loc3_.figure);
      ...
      {
         if(var_995.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
