package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2193:BitmapData;
      
      protected var var_876:Boolean;
      ...
      protected var var_360:BitmapData;
      
      private const const_1417:Number = 0.2;
      
      protected var var_1312:Boolean;
      
      private const const_1416:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_520)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1492));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1303);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1416;
               _loc1_.blend = const_1416;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1312 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2193;
               _loc5_.visible = true;
            }
            else
            {
