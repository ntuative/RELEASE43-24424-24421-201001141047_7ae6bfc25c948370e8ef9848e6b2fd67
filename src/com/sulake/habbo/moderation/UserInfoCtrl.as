package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_778:int = 31536000;
      
      private static const const_777:int = 86400;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_777) + " days ago";
         }
         return Math.round(param1 / const_778) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_58,WindowTracker.const_875,_data.userId),_callerFrame,var_1028,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new ModActionCtrl(var_58,_data.userId,_data.userName,var_1264),_callerFrame,var_1028,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new RoomVisitsCtrl(var_58,_data.userId),_callerFrame,var_1028,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new SendMsgsCtrl(var_58,_data.userId,_data.userName,var_1264),_callerFrame,var_1028,false,true);
      }
