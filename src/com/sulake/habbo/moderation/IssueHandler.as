package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_378:UserInfoCtrl;
      
      private var var_64:ModerationManager;
      
      private var var_913:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_64.issueManager.releaseBundle(var_117.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_378 = new UserInfoCtrl(_window,var_64,_loc3_.message);
         var_913 = new UserInfoCtrl(_window,var_64,_loc3_.message);
         var_378.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_117.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_913.load(_loc4_,var_117.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_64.issueManager.closeBundle(var_117.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_64,WindowTracker.const_939,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_64 != null && false && var_117 != null)
         {
            var_64.issueManager.removeHandler(var_117.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_378 = new UserInfoCtrl(_window,var_64,_loc3_.message);
            var_378.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_64.issueManager.closeBundle(var_117.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_64.issueManager.closeBundle(var_117.id,3);
         checkAutoHandling();
         dispose();
      }
