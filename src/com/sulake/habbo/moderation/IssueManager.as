package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_972:String = "issue_bundle_open";
      
      public static const const_511:String = "issue_bundle_my";
      
      public static const const_800:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_134 = new Map();
         var_801 = new Map();
         var_552 = new IssueBrowser(this,var_64.windowManager,var_64.assets);
         var_653 = [];
         var_802 = [];
         var_976 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_976.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_653 = var_653.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_801.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_801.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1351)
         {
            var_152.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_134)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_801.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_801.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_142)
         {
            ...
            _loc8_ = var_802.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_976.remove(param1);
         var_976.add(param1,_loc3_);
      ...
      {
         var _loc2_:* = var_976.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_552 == null || !var_552.isOpen())
         {
            var_64.soundManager.playSound(HabboSoundTypesEnum.const_841);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_801.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_134.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
