package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1499:IIssueBrowserView;
      
      private const const_1622:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1623:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1498:IIssueBrowserView;
      
      private const const_1631:String = "closed_issues";
      ...
      private var var_1500:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_346.view.width = var_236.container.width;
         var_346.view.height = var_236.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1624:
               if(var_1498 == null)
               {
                  var_1498 = new MyIssuesView(issueManager,this,var_236.container);
               }
               return var_1498;
            case const_1622:
               if(var_1499 == null)
               {
                  var_1499 = new OpenIssuesView(issueManager,this,var_236.container);
               }
               return var_1499;
            case const_1623:
               if(var_1500 == null)
               {
                  var_1500 = new PickedIssuesView(issueManager,this,var_236.container);
               }
               return var_1500;
            default:
               return null;
