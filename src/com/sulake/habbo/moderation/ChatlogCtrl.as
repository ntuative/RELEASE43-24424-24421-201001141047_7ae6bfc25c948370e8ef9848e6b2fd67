package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1461:IMessageComposer;
      ...
      {
         var_767 = IWindowContainer(var_58.getXmlWindow("chatlog_roomheader"));
         var_768 = IWindowContainer(var_58.getXmlWindow("chatlog_chatline"));
         var_447 = new Timer(300,1);
         var_447.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_60 = IFrameWindow(var_58.getXmlWindow("chatlog_frame"));
         _list = IItemListWindow(var_60.findChildByName("chatline_list"));
         var_60.procedure = onWindow;
         var _loc1_:IWindow = var_60.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_58.connection.send(var_1461);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_767.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_60,var_58,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_768.clone());
         _loc4_.color = var_1131[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_60,var_58,_loc6_,param2.chatterId);
         }
