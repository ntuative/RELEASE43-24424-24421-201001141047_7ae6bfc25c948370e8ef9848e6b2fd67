package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1542.clone());
         ...
         new OpenRoomTool(var_60,var_58,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_1542 = IWindowContainer(var_58.getXmlWindow("roomvisits_row"));
         ...
         var_60 = IFrameWindow(var_58.getXmlWindow("roomvisits_frame"));
