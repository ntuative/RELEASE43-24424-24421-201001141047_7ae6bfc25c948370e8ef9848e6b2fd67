package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1334:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1075));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1334[var_1075]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(_friendList.view.mainWindow,var_246.width,var_246.height);
         var_246.x = _loc2_.x;
         var_246.y = _loc2_.y;
         var_1334[var_1075] = var_246;
      }
   }
}
