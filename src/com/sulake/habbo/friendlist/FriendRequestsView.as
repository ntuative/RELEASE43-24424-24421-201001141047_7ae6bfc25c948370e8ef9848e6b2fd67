package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1406:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_290 && _loc4_.state != FriendRequest.const_314)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_290;
      ...
      {
         var_1403 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1404 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1404.procedure = onDismissAllButtonClick;
         var_1403.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_290)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1403,_loc1_);
         setEnabled(var_1404,_loc1_);
      }
