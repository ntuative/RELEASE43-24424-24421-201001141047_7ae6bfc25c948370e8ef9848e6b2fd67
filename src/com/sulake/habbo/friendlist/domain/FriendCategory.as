package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_227.length / const_306);
      }
      ...
      {
         if(this.var_825 >= this.getPageCount())
         {
            this.var_825 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_825 + 1) * const_306,this.var_227.length);
      }
