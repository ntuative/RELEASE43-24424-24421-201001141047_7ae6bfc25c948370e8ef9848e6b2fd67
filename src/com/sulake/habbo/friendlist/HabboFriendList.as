package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1820:IAvatarRenderManager;
      
      private var var_1487:AvatarSearchResults;
      
      private var var_140:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_845:FriendRequests;
      
      private var var_1949:int;
      
      var var_338:FriendCategories;
      
      private var var_187:IHabboToolbar;
      
      private var var_2067:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_393:FriendListTabs;
      
      private var var_2068:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1488:OpenedToWebPopup;
      ...
      {
         var_2067 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_338 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1487 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1488 == null)
         {
            var_1488 = new OpenedToWebPopup(this);
         }
         var_1488.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_845.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_845.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_393.findTab(FriendListTab.const_102).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_845.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_140 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_338.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_845 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_338.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_338.addCategory(new FriendCategory(FriendCategory.const_959,getText("friendlist.friends")));
         var_338.addCategory(new FriendCategory(FriendCategory.const_435,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_338.addFriend(new Friend(_loc4_));
         }
         var_393 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_338.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1820.createAvatarImage(param1,AvatarScaleType.const_97);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1820 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_845.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_393.findTab(FriendListTab.const_102);
      ...
      {
         var_2068 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_338.getFriendCount(param1,param2);
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_393.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1487.searchReceived(_loc2_.friends,_loc2_.others);
