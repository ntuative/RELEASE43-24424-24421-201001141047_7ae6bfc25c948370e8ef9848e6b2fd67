package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1385:uint = 2;
      
      protected static const const_1389:uint = 1;
      
      protected static const const_1386:int = 5;
      
      protected static const const_1033:uint = 7;
      
      protected static const const_1387:uint = 4;
      
      protected static const const_1388:uint = 3;
       
      
      protected var var_875:int;
      
      protected var var_2191:String = "";
      
      protected var var_357:int;
      
      protected var var_495:XML;
      
      protected var var_1311:Boolean = false;
      
      protected var var_421:uint = 0;
      
      protected var var_1:Loader;
      
      protected var var_2190:String = "";
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_495 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_421 == LibraryLoader.const_1388)
         {
            if(analyzeLibrary())
            {
               var_421 |= 0;
         ...
         if(var_421 == LibraryLoader.const_1033)
         {
            var_1311 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_875 > 0)
            {
               var_1.close();
               var_1.unload();
               addRequestCounterToUrlRequest(var_310,const_1386 - var_875);
