package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      public static const const_1359:int = 6;
      
      private static const const_1105:String = "library";
      
      public static const const_1370:int = 99;
      ...
      private static const const_1109:String = "asset-libraries";
      ...
      private static const const_1103:String = "service-libraries";
      
      private static const const_1106:String = "component-libraries";
      ...
      private var var_123:DisplayObjectContainer;
      ...
      private var var_673:ProfilerViewer;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1221:
               debug("Core; using simple frame update handler");
               var_123.addEventListener(Event.ENTER_FRAME,simpleFrameUpdateHandler);
               break;
            case Core.const_840:
               debug("Core; using complex frame update handler");
               var_123.addEventListener(Event.ENTER_FRAME,complexFrameUpdateHandler);
               break;
            case Core.const_1286:
               debug("Core; using profiler frame update handler");
               var_123.addEventListener(Event.ENTER_FRAME,profilerFrameUpdateHandler);
               var_840 = new Profiler(this);
               attachComponent(var_840,[new IIDProfiler()]);
               var_673 = new ProfilerViewer();
               var_123.addChild(var_673);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:ICoreUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = var_569[_loc4_] as Array;
      ...
      private function updateConfigStatusListener() : void
      {
         ...
         if(var_112)
         {
            ...
            if(var_568 > 0)
            {
               _loc1_ += var_568 + var_234.length - 1;
            }
            else
            {
               _loc1_ += var_234.length;
            }
            var_112.percent = (Number(var_272) - _loc1_) / Number(var_272);
         }
      }
      ...
      private function complexFrameUpdateHandler(param1:Event) : void
      {
         ...
         var msCurrentTime:uint = getTimer();
         var msSinceLastUpdate:uint = msCurrentTime - var_410;
         var maxTimePerFrame:uint = 1000 / DisplayObject(var_123).stage.frameRate;
         var_410 = msCurrentTime;
         criticality = 0;
         while(criticality < CoreComponent.const_151)
         {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_123.removeEventListener(Event.ENTER_FRAME,simpleFrameUpdateHandler);
            var_123.removeEventListener(Event.ENTER_FRAME,complexFrameUpdateHandler);
            var_123.removeEventListener(Event.ENTER_FRAME,profilerFrameUpdateHandler);
            var_123 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponent.const_151)
            {
               _loc2_ = var_569[_loc3_] as Array;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,const_1170);
         updateLoadingProcess(param1);
      }
      
      private function updateArchiveLoadingItemProgress(param1:ProgressEvent) : void
      {
         var_568 = 1 - param1.bytesLoaded / param1.bytesTotal;
         if(var_568 > 0)
         {
            updateConfigStatusListener();
         }
      ...
      override public function registerUpdateReceiver(param1:ICoreUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = var_569[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            error("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",true,const_805);
