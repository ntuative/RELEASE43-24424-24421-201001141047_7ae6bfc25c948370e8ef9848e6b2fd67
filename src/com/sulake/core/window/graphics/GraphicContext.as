package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_868:uint = 256;
      
      protected static var var_590:uint = 0;
      
      protected static var var_363:uint = 0;
      
      public static const const_821:uint = 2;
      
      public static const const_1512:uint = 128;
      
      public static const const_1565:uint = 64;
      
      public static const const_497:uint = 4;
      
      public static const const_1365:uint = 0;
      
      public static const const_1373:uint = 16;
      
      public static const const_725:uint = 1;
      
      public static const const_1184:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_585:Boolean;
      
      protected var var_1534:Boolean;
      
      protected var var_164:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_821:
               ...
               break;
            case GraphicContext.const_1184:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1373:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_497:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_868:
               break;
            case GraphicContext.const_1365:
               break;
            default:
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_164 = new Sprite();
            var_164.name = this.name + " - Child Container";
            var_164.mouseEnabled = false;
            addChild(var_164);
         }
         return var_164;
      }
         ...
         if(var_585)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1534,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1534,16777215);
                  }
                  var_363 += bitmap.width * bitmap.height * 4;
               }
