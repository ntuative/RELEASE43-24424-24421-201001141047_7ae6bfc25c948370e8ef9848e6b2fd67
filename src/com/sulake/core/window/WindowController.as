package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      private static var var_1184:uint = 0;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_30)
         {
            var_30 = getGraphicContext(!testParamFlag(WindowParam.const_30));
         }
         ...
         if(_loc12_ != null)
         {
            var_361 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_61 = var_361.clone();
            var_22 = var_361.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_124,WindowParam.const_133);
         var _loc2_:* = !testParamFlag(WindowParam.const_112,WindowParam.const_145);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
      ...
      {
         var_5 = param1;
         var_586 = !!var_5 ? uint(var_586 | var_1318) : uint(var_586 & 16777215);
      ...
      {
         if(_state == WindowState.const_392)
         {
            return true;
         }
         _state = WindowState.const_392;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_784,this,null);
         update(this,_loc1_);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1875 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_794:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1241:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1211:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_784:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_802:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_649:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1009:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_562:
               _loc2_ = "null";
               break;
         ...
         if(_loc2_ == WindowEvent.const_169)
         {
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_30)
         {
            var_30 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_725,var_22);
      ...
      {
         var_395 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_29.invalidate(this,var_22,WindowRedrawFlag.const_842);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_973 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_292,this,param1));
         return param1;
      }
      ...
      {
         return !testParamFlag(WindowParam.const_30) || var_30 != null;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_707);
      }
      
      public function set color(param1:uint) : void
      {
         var_1318 = param1 & 4278190080;
         var_586 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         var_29.invalidate(this,var_22,WindowRedrawFlag.const_72);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_718))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_944;
                  if(testParamFlag(WindowParam.const_301))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_213))
                        {
                  ...
                  if((var_31 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_238))
                        {
                           var_29.getWindowServices().getMouseScalingService().begin(_loc5_,var_31 & 0);
                           break;
                        }
                        _loc5_ = _loc5_.parent;
                     }
               ...
               case MouseEvent.MOUSE_OUT:
                  if(testStateFlag(WindowState.const_77))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_230:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_424,this,null));
                     if(testParamFlag(WindowParam.const_152,WindowParam.const_133))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_161,WindowParam.const_145))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        _loc8_ = uint(var_31);
                        var_31 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_425))
                        {
                           var_23.width += 0 - 0;
                        }
                        ...
                        var_31 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_268,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_449:
                  var_29.invalidate(this,var_22.union(var_61),WindowRedrawFlag.const_423);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_846,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_258,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_280:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_705,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_209,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_386:
                  var_29.invalidate(this,var_22,WindowRedrawFlag.const_996);
                  break;
               case WindowNotifyEvent.const_407:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_364:
                  if(!(var_31 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_29.invalidate(this,var_22,WindowRedrawFlag.const_423);
                     }
                  }
                  else if(var_31 & 0)
                  {
               ...
               case WindowNotifyEvent.const_209:
                  ...
                  break;
               case WindowNotifyEvent.const_424:
                  var_23.getRegionProperties(null,var_292);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_292:
      ...
      {
         return var_582 != null ? var_582 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_707);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_280;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_687,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_562;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_973 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_363)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_31 & 0);
            if(_loc7_ == WindowParam.const_352)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_832,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_609,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_449,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_230,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1229,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_62,true);
         _loc1_.type = WindowNotifyEvent.const_1168;
         update(this,_loc1_);
         return true;
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_31 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_364,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_292 = var_23.rectangle.clone();
               var_61.x = var_22.x;
               var_61.y = var_22.y;
               var_61.width = var_22.width;
               var_61.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_475,this,var_23));
            }
            else
            {
               var_292.x = 0;
               ...
               var_292.width = 0;
               var_292.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_838,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_86,var_31,var_29,var_22,null,var_582,properties,var_587.concat(),_id) as WindowController;
         _loc2_.var_707 = var_707;
         _loc2_._drawable = _drawable;
         _loc2_.var_1310 = var_1310;
         _loc2_.var_292 = var_292.clone();
         _loc2_.var_22 = var_22.clone();
         _loc2_.var_361 = var_361.clone();
         ...
         _loc2_.var_1318 = var_1318;
         _loc2_.var_1056 = var_1056;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_649;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_604;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_707 = param1 > 255 ? 255 : uint(param1);
      }
