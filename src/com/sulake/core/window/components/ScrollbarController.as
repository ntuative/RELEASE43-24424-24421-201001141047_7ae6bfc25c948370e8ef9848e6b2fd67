package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1039:String = "increment";
      
      private static const const_482:String = "slider_bar";
      
      private static const const_1040:String = "decrement";
      
      private static const const_745:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         _drawable = false;
         var_36 = param12;
         _horizontal = param2 == WindowType.const_468;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.name)
            {
               case ScrollbarController.const_482:
                  if(param2.type == WindowNotifyEvent.const_258)
                  {
                     if(!var_514)
                     {
                        if(_horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_475)
         {
            if(var_36 == null)
            {
               resolveScrollTarget();
      ...
      {
         return getChildByName(ScrollbarController.const_745) as WindowController;
      }
      ...
      {
         return track.getChildByName(ScrollbarController.const_482) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_729 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_729 != null)
         {
            _loc1_ = findParentByName(var_729) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_729) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1039)
            {
               if(var_36)
               {
                  var_514 = true;
            ...
            else if(param2.name == ScrollbarController.const_745)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_872)
         {
