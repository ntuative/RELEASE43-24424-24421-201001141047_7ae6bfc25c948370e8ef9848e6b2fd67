package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1015:String = "resize_on_item_update";
      
      protected static const const_1014:String = "spacing";
      
      protected static const const_1381:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1013:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1382:Boolean = true;
      ...
      protected var var_2254:Number = 0;
      
      protected var var_499:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_95 = 0;
         var_72 = 0;
         _horizontal = param2 == WindowType.const_324;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         _drawable = var_5 || !testParamFlag(WindowParam.const_30);
         _container = var_29.create("_CONTAINER","",WindowType.const_321,WindowStyle.const_250,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_299,containerEventHandler);
      ...
      {
         return new Rectangle(var_498 * maxScrollH,var_500 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_299,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_498 = param1;
            _container.x = -var_498 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1014,_spacing,PropertyStruct.const_60,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1016,var_705,PropertyStruct.const_54,var_705 != const_1382));
         _loc1_.push(new PropertyStruct(const_1013,var_499,PropertyStruct.const_54,var_499 != const_1381));
         _loc1_.push(new PropertyStruct(const_1015,var_1046,PropertyStruct.const_54,var_1046 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_500 = param1;
            _container.y = -var_500 * maxScrollV;
            var_29.invalidate(_container,visibleRegion,WindowRedrawFlag.const_72);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1015:
                  ...
                  break;
               case const_1016:
                  var_705 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_425,param1);
            }
            else
            {
