package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1124:String = "content";
      
      private static const const_1125:String = "selector";
       
      
      private var var_1207:Boolean = false;
      
      protected var var_882:ITabSelectorWindow;
      
      private var var_828:Boolean = false;
      
      protected var var_1535:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1535 == null)
         {
            var_1535 = findChildByTag(TabContextController.const_1124) as IWindowContainer;
         }
         return var_1535;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_882 == null)
         {
            var_882 = findChildByTag(TabContextController.const_1125) as ITabSelectorWindow;
            if(var_882 != null)
            {
               var_882.procedure = selectorEventProc;
            }
         }
         return var_882;
      }
      ...
      {
         return !!var_828 ? selector.iterator : null;
      }
