package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_143:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_143 == null || false)
         {
            var_143 = context.create(name + "::submenu","",WindowType.const_383,var_86,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_143.setGlobalRectangle(_loc1_);
         }
         var_143.activate();
         return var_143;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.const_98)
         {
            ...
            {
               if(param2.testStateFlag(WindowState.const_77))
               {
         ...
         else if(param1.type == WindowEvent.const_791)
         {
            if(param2 == var_143)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_443,var_86,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         if(var_480 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_480).setStateFlag(WindowState.const_46,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_573)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_481,getSubMenu(),subMenuEventProc);
                  var_573 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_480 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_283,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_143 != null)
            {
               _loc2_ = var_143.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_573 = false;
            getTitleText().text = var_480 < var_481.length && var_480 > -1 ? "null" : caption;
         }
      }
   }
}
