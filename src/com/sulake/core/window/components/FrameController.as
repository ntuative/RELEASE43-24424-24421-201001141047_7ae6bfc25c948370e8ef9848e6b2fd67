package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_739:String = "margin_top";
      
      private static const const_1031:String = "_HEADER";
      
      private static const const_741:String = "margin_right";
      
      private static const const_1029:String = "_SCALER";
      
      private static const const_1030:String = "_TITLE";
      
      private static const const_1028:String = "_CONTENT";
      
      private static const const_740:String = "margin_left";
      
      private static const const_738:String = "margin_bottom";
      ...
      private var var_1065:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_740,_loc3_.left,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_739,_loc3_.top,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_741,0 - _loc3_.right,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_738,0 - _loc3_.bottom,PropertyStruct.const_60,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_238);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_217);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_221);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1065 == null)
         {
            var_1065 = findChildByTag(const_1031) as IHeaderWindow;
            if(!var_1065)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1030) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1029) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1311 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_34 == null)
         {
            var_34 = findChildByTag(const_1028) as IWindowContainer;
            if(!var_34)
            {
