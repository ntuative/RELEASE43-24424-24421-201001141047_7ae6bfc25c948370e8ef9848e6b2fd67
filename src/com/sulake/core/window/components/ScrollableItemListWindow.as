package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_778:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_335)
         {
            ...
            if(var_335)
            {
               var_335.addEventListener(WindowEvent.const_228,scrollBarEventProc);
               var_335.addEventListener(WindowEvent.const_208,scrollBarEventProc);
            }
         }
         return var_335;
      }
      ...
      override public function dispose() : void
      {
         if(var_335)
         {
            var_335.removeEventListener(WindowEvent.const_228,scrollBarEventProc);
            var_335.removeEventListener(WindowEvent.const_208,scrollBarEventProc);
            var_335 = null;
         }
         if(var_778)
         {
      ...
      {
         if(param1.type == WindowEvent.const_228)
         {
            showScrollBar();
         }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_778)
         {
            var_778 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_778;
      }
