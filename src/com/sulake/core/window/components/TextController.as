package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2256:Rectangle = new Rectangle();
      ...
      protected var var_501:String = "none";
      
      protected var var_581:Number;
      
      protected var var_356:Number;
      ...
      {
         return new Rectangle(var_581 * maxScrollH,var_356 * maxScrollV,width,height);
      }
      ...
      {
         var_581 = param1;
         _field.scrollH = var_581 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_862,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_452,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_452,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_702,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_702,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_54,true));
         _loc1_.push(new PropertyStruct("margin_left",var_73.left,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("margin_top",var_73.top,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("margin_right",var_73.right,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_73.bottom,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("auto_size",var_501,PropertyStruct.STRING,var_501 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_702,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_581 = var_581;
         _loc1_.var_356 = var_356;
         _loc1_.var_73 = var_73.clone(_loc1_.setTextMargins);
         _loc1_.var_501 = var_501;
         _loc1_.var_706 = var_706;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_501 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_501 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_501 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_501 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
