package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_30)
         {
            var_30 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_821,var_22);
         }
         return var_30;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_874,PropertyStruct.const_54,var_874 != false));
         return _loc1_;
      }
      ...
      {
         var _loc2_:* = null;
         InteractiveController.method_3(this,param1);
         for each(_loc2_ in param1)
         {
            if(_loc2_.key == "focus_capturer")
            {
               var_874 = _loc2_.value as Boolean;
               if(var_874)
               {
