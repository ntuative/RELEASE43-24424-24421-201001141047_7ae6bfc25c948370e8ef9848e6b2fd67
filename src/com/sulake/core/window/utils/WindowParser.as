package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1520:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1488:String = "_TEMP";
      
      private static const const_1064:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1063:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1050:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_873:Dictionary;
      
      protected var var_1309:Map;
      
      protected var var_29:IWindowContext;
      
      protected var var_1308:Dictionary;
      
      protected var var_1049:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1050 = new Dictionary();
         TypeCodeTable.fillTables(var_1049,var_1050);
         var_873 = new Dictionary();
         var_1308 = new Dictionary();
         ParamCodeTable.fillTables(var_873,var_1308);
         var_1309 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1063,"");
         return param1.replace(const_1064,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1049)
            {
               delete var_1049[_loc1_];
            }
            for(_loc1_ in var_1050)
            {
               delete var_1050[_loc1_];
            }
            for(_loc1_ in var_873)
            {
               delete var_873[_loc1_];
            }
            for(_loc1_ in var_1308)
            {
               delete var_1308[_loc1_];
            }
            var_1309.dispose();
            var_1309 = null;
            var_29 = null;
