package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1027:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_580:uint = 0;
      
      public static const const_967:String = "AssetLibraryReady";
      
      public static const const_1353:String = "AssetLibraryUnloaded";
      ...
      private var var_496:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_580;
         var_418 = new Dictionary(false);
         var_417 = new Dictionary(false);
         var_698 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_418)
         {
            _loc4_ = AssetTypeDeclaration(var_418[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         var_308 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1353));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_495 = _loc2_.manifest.copy();
         var_353 = _loc2_.resource;
         if(var_496)
         {
            AssetLibrary.fetchLibraryContents(this,var_495,var_353);
         }
         var_308 = true;
         dispatchEvent(new Event(AssetLibrary.const_399));
         dispatchEvent(new Event(AssetLibrary.const_967));
         if(var_496)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_417[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_941,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_844,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_922,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_417[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_418.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_418[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1027.splice(var_1027.indexOf(this),1);
            --var_580;
            var_417 = null;
            var_698 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_352.length ? getAssetByName(var_352[param1]) : null;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_418)
         {
            _loc3_ = AssetTypeDeclaration(var_418[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_698[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_1310);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_495.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_417[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_352.splice(var_352.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_418[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
