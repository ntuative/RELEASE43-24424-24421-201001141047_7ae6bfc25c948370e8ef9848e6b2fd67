package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_653:Number = 64;
      
      public static const const_847:Number = 32;
      ...
      private var var_1340:Number = 1;
      
      private var var_2258:Number = 500;
      ...
      private var var_2257:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_91 = new Vector3d();
         var_897 = new Vector3d();
         var_1339 = 1;
         var_1338 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1340 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_375 != param1 * var_1340)
         {
            var_375 = param1 * var_1340;
            ++var_82;
         }
      }
      ...
      {
         if(var_374 != param1 * var_1339)
         {
            var_374 = param1 * var_1339;
            ++var_82;
         }
      }
      ...
      {
         if(var_372 != param1 * var_1338)
         {
            var_372 = param1 * var_1338;
            ++var_82;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_373 != null)
         {
            ...
            var_373.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_373.add(_loc3_,_loc4_);
            ++var_82;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_897.assign(_loc22_);
         }
         else
         {
            var_897.assign(_loc17_);
         }
         ++var_82;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_372;
         _loc2_.z *= var_375;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_897);
         if(_loc3_ < var_2257 || _loc3_ > var_2258)
         {
            return null;
         }
         ...
         _loc4_ *= var_197;
         _loc5_ *= var_197;
         var _loc6_:IVector3d = method_4(param1);
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_372;
            _loc2_.z *= var_375;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_897);
         }
      ...
      {
         return new Vector3d(0 * var_374,0 * var_372,0 * var_375);
      }
      ...
      private function method_4(param1:IVector3d) : IVector3d
      {
         var _loc2_:* = null;
         if(var_373 != null)
         {
            _loc2_ = int(Math.round(param1.x)) + "_" + int(Math.round(param1.y)) + "_" + int(Math.round(param1.z));
            return var_373.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_374,0 * var_372,0 * var_375);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_91;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_374,param2.y * var_372,param2.z * var_375);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_374,param3.y * var_372,param3.z * var_375);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_374,param4.y * var_372,param4.z * var_375);
