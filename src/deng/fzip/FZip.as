package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_484 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_673))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_673,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_99 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_673,"EOF"));
            }
         }
      }
      ...
      {
         if(var_484.parse(param1))
         {
            var_55.push(var_484);
            if(false)
            {
               var_144["null"] = var_484;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1146,var_484));
            var_484 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_55 != null && var_144 != null && param1 < var_55.length)
         {
